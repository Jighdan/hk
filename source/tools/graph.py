...
def _is_point_in_range(target: Point, limiter: float) -> bool:
...
def shortest_distance_from_set(set_of_points: List[Point], target: Point) -> Point:
...
def adjacent_points(origin: Point, limiter: float) -> List[Point]:
